...
//     });
//   }, [preferences, percentage, foodTags, activityTags, setPreferences]);
...
export default function Preferences({ preferences, setPreferences }) {
  ...
  useEffect(() => {
    // Only set preferences if they have actually changed
    ...
    // Check if preferences have actually changed to prevent unnecessary re-renders
    if (
      JSON.stringify(updatedPreferences.food) !== JSON.stringify(preferences.food) ||
      JSON.stringify(updatedPreferences.activities) !== JSON.stringify(preferences.activities)
    ) {
      setPreferences(updatedPreferences);
    }
  }, [percentage, foodTags, activityTags, preferences, setPreferences]);
